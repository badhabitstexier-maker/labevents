...
For review of Lot 3 `/realisations`, also read `docs/decisions/2026-08-12-lot3-realisations.md`, which records the permitted proof content, the study-case/capture safeguards and the page structure. It supplements `CLAUDE.md` and never overrides it.
